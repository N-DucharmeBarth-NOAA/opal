...
- [`convert_rtmb_selex_to_ss3()`](https://n-ducharmebarth-noaa.github.io/opal/reference/convert_rtmb_selex_to_ss3.md)
  : Convert RTMB real-line selectivity parameters back to SS3 natural
  scale

- [`convert_ss3_selex_to_rtmb()`](https://n-ducharmebarth-noaa.github.io/opal/reference/convert_ss3_selex_to_rtmb.md)
...
- [`get_harvest_rate()`](https://n-ducharmebarth-noaa.github.io/opal/reference/get_harvest_rate.md)
...
- [`get_recruitment()`](https://n-ducharmebarth-noaa.github.io/opal/reference/get_recruitment.md)
...
- [`opal_baseline_data`](https://n-ducharmebarth-noaa.github.io/opal/reference/opal_baseline_data.md)
  : Opal Baseline Data

- [`opal_baseline_map`](https://n-ducharmebarth-noaa.github.io/opal/reference/opal_baseline_map.md)
  : Opal Baseline Map
...
- [`plot_catch()`](https://n-ducharmebarth-noaa.github.io/opal/reference/plot_catch.md)
  : Plot catch
