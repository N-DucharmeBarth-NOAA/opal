...
```{r config, echo=TRUE}
compare       <- TRUE
baseline_file            <- file.path("data", "opal_baseline.rda")
baseline_data_file       <- file.path("data", "opal_baseline_data.rda")
baseline_parameters_file <- file.path("data", "opal_baseline_parameters.rda")
baseline_map_file        <- file.path("data", "opal_baseline_map.rda")
bench_iters              <- 20
```
...
if (!compare) {
  ...
  save(opal_baseline, file="data/opal_baseline.rda")

  opal_baseline_data <- data
  save(opal_baseline_data, file = "data/opal_baseline_data.rda")

  opal_baseline_parameters <- parameters
  save(opal_baseline_parameters, file = "data/opal_baseline_parameters.rda")

  opal_baseline_map <- map
  save(opal_baseline_map, file = "data/opal_baseline_map.rda")
