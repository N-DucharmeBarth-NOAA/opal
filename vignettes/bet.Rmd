...
`opal` is an open, modular R package for fisheries stock assessment built on [RTMB](https://github.com/kaskr/RTMB) for automatic differentiation. It includes bundled data from the western and central Pacific Ocean (WCPO) bigeye tuna (BET) stock assessment. This vignette demonstrates model setup, fitting, and diagnostics using those data.
