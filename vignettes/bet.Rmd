...
map_sel[8, 1:4] <- 1:4 # peak, plateau, asc-width, desc-width
map_sel[9, 1:4] <- 5:8 # peak, plateau, asc-width, desc-width
map_sel[10, 1:4] <- 9:12 # peak, plateau, asc-width, desc-width
map_sel[11, 1:4] <- 13:16 # peak, plateau, asc-width, desc-width
map_sel[12, 1:4] <- 17:20 # peak, plateau, asc-width, desc-width
map_sel[13, 1:4] <- 21:24 # peak, plateau, asc-width, desc-width
map_sel[14, 1:4] <- 25:28 # peak, plateau, asc-width, desc-width
...
ggplot(data = sel_len_df, aes(x = length, y = selectivity, colour = estimated)) +
  geom_line() +
