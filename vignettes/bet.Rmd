...
data$lf_obs_flat <- unlist(lapply(lf_obs_list, function(m) as.numeric(t(m)))) # for multinomial
data$lf_obs_ints <- unlist(lapply(lf_obs_list, function(m) as.numeric(t(round(m))))) # for Dirichlet-multinomial
data$lf_obs_prop <- unlist(lapply(lf_obs_list, function(m) { # for Dirichlet
...
obj$simulate()$lf_obs_prop
obj$simulate()$lf_obs_ints
