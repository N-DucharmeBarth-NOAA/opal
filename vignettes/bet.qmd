...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Natural mortality-at-age and maturity-at-length input curves for WCPO BET."
ages <- data$age_a
real_age <- ages / 4
...
# var_adjust_scalars <- rep(1 / 20000, data$n_fishery)
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Initial model diagnostics showing spawning biomass trajectory and catch fit."
...
#| echo: true
#| message: false
#| tbl-cap: "Lower and upper bounds used for model parameter optimization."
...
#| echo: true
#| message: false
#| tbl-cap: "Comparison of initial and estimated model parameter values with bounds and gradient checks."
...
#| echo: true
#| message: false
#| tbl-cap: "Parameter pairs with absolute correlation above the diagnostic threshold."
...
#| fig-height: 6
#| fig-width: 7
#| fig-cap: "Observed, predicted, and simulated length compositions by year for selected fisheries."
if (data$lf_switch == 0) {
...
#| fig-height: 5
#| fig-width: 7
#| fig-cap: "Observed and predicted weight compositions by year for the first fishery with weight data."
if (data$wf_switch == 0) {
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Observed, predicted, and simulated CPUE time series diagnostics."
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Observed versus predicted catch and catch residual diagnostics."
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Estimated spawning biomass trajectory across time steps."
plot(obj$report()$spawning_biomass_y, type = "l",
     xlab = "Time step", ylab = "Spawning biomass (mt)",
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "Observed and simulated log-CPUE series generated from the fitted model."
if(data$cpue_switch == 0){
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: "OSA residual diagnostics for CPUE (QQ plot and residual index plot)."
if(data$cpue_switch == 0){
