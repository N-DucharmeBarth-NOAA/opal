...
# Retained diagnostic set after sequential LF/WF exploration:
# - LF8 is included with strong downweighting (lf_var_adjust = 5000).
# - WF5 failed to converge cleanly, so it remains inactive.
# - LF14 is peak-only because freeing width parameters led to boundary-width
#   solutions with little improvement in the diagnostic fit.
next_sel_level <- 1L
...
free_sel(9, c(1, 3, 4))   # peak, asc-width, desc-width
free_sel(10, c(1, 3, 4))  # peak, asc-width, desc-width
free_sel(11, 1:2)         # logistic inflection and width
free_sel(12, c(1, 3, 4))  # peak, asc-width, desc-width
free_sel(13, c(1, 3, 4))  # peak, asc-width, desc-width
free_sel(14, 1)           # peak only; width parameters remain fixed

free_sel(1, c(1, 3, 4))   # peak, asc-width, desc-width
free_sel(2, c(1, 3, 4))   # peak, asc-width, desc-width
free_sel(3, c(1, 3, 4))   # peak, asc-width, desc-width
free_sel(4, c(1, 3, 4))   # peak, asc-width, desc-width
free_sel(6, c(1, 3, 4))   # peak, asc-width, desc-width
free_sel(7, c(1, 3, 4))   # peak, asc-width, desc-width
