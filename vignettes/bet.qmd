...
estimated for all model time steps. Initial age deviations are fixed at zero so
the initial age structure remains at equilibrium.
...
#| fig-height: 4
#| fig-width: 7
#| fig-cap: Estimated recruitment deviations across all model time steps.
