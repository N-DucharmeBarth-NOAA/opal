...
```{r run-nlminb, echo=TRUE, results="hide", eval=FALSE}
...
```{r opt-results, echo=TRUE, message=FALSE, eval=FALSE}
...
```{r opt-spbio, echo=TRUE, message=FALSE, fig.height=4, fig.width=7, eval=FALSE}
...
```{r opt-spdep, echo=TRUE, message=FALSE, fig.height=4, fig.width=7, eval=FALSE}
# Use sdreport output for uncertainty (Report from `sdreport(obj)`).
...
```{r osa1, echo=TRUE, message=FALSE, fig.height=4, fig.width=7, eval=FALSE}
if (data$cpue_switch == 0) {
