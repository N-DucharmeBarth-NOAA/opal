...
If you encounter an error that the dependency
[`SparseNUTS`](https://github.com/noaa-afsc/SparseNUTS) is not
available, you will need to install it manually. `SparseNUTS` is not
...
[vignettes](https://n-ducharmebarth-noaa.github.io/opal/vignettes/) and
inline function documentation (`?opal`).
...
See [LICENSE](https://n-ducharmebarth-noaa.github.io/opal/LICENSE) for
