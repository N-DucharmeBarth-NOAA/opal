...
# SS3 initial parameter values per fleet (from 01-make-baseline-ss3-model.r)
# Columns: peak, top_logit, ascend_se, descend_se, start_logit, end_logit
ss3_selex_pars <- matrix(NA, nrow = 15, ncol = 6)

# F01-F07: Longline fleets (double-normal, pattern 24)
for (f in 1:7) {
...
# F11: Domestic handline (logistic, pattern 1) — only first 2 cols used
...
# F15: Index fishery (logistic, pattern 1) — only first 2 cols used
