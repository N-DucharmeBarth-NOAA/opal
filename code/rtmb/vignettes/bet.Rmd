...
opt <- nlminb(start = obj$par, objective = obj$fn, lower = Lwr, upper = Upr, control = control)
opt <- nlminb(start = opt$par, objective = obj$fn, lower = Lwr, upper = Upr, control = control)
obj$gr()
