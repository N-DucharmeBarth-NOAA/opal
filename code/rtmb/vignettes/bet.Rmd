...
# Stored as data$fecundity (consistent with data$maturity / data$M naming);
# resolved to age-basis inside bet_model() via resolve_bio_vector().
data$fecundity <- get_weight_at_length(len_mid, data$lw_a, data$lw_b)
