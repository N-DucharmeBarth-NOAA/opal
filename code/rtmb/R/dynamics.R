...
#'
#' @param B0 Unfished spawning output (maturity × fecundity × numbers).
#' @param h Beverton-Holt steepness parameter.
#' @param M_a a \code{vector} of natural mortality at age.
#' @param spawning_potential_a a \code{vector} of spawning potential at age (maturity × fecundity).
...
#'   minimum: \code{rdev_y}.
#' @param B0 Numeric. Unfished equilibrium spawning output.
